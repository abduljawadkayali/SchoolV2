...
namespace App\Http\Controllers;
    ...
    public function getGroups()
    {
        ...
        //dd($teacher);
        return view('respon.create',compact('group', 'teacher', 'year', 'semister','schools'));
    }
...
//dd($respon);
        return view('respon.index',compact('respon'));
        ...
        public function edit($id)
        {
            ...
            return view('respon.edit', compact('schools','respon', 'group', 'teacher', 'year', 'semister'));
        }
