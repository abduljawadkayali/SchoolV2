...
<link rel="icon" sizes="16x16" href="/theme/images/marker-icon.png">
<link rel="icon" sizes="16x16" href="/theme/images/marker-shadow.png">
<link rel="icon" sizes="16x16" href="/theme/images/marker-icon-2x.png">
    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">اتصل بنا</h2>
            </div>
