        ...
        <div class="container">
            <div class="hero-content text-center">
                <div class="section-heading">
                    <h2 class="section__title fs-60 lh-80 pb-3 theme-font-2">أحدث المهارات الرقمية مع أفضل المدربين<br> في متناول اليد.</h2>
                    <p class="section__desc pb-5">اكتشف الطريقة الأسرع والأكثر فعالية لاكتساب خبرة <br> جاهزة للوظائف للمهن المستقبلية.</p>
                </div><!-- end section-heading -->

                    <div class="form-group mb-0">
                        <input class="form-control form--control pl-3 shadow-sm border-0" type="text" name="search" placeholder="ماذا تريد أن تتعلم؟">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info--box hover-y">
                    ...
                    <h3 class="info__title theme-font-2 font-weight-bold">المدربين الخبراء</h3>
                    <p class="info__text">تعلم مع مدرسينا ومدربيني الشغوفين بالتعليم</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info--box hover-y">
                    <div class="icon-element bg-3">
                        <svg class="svg-icon-color-white" width="35" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512"  xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                    ...
                    <h3 class="info__title theme-font-2 font-weight-bold">في الجدول الزمني الخاص بك</h3>
                    <p class="info__text">انضم لتدريباتنا ودوراتنا بما يناسب وقتك</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
