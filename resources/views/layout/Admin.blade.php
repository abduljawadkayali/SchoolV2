            ...
            <div>
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"><ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="/courseCategory" class="nav-link">
                                    <i class="fas fa-newspaper"></i>
                                    <p>@lang("CourseCategory")</p>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="/courseView" class="nav-link">
                                    <i class="fas fa-newspaper"></i>
                                    <p>@lang("CourseView")</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="/backgroundOther" class="nav-link">
                                    <i class="fas fa-newspaper"></i>
                                    <p>@lang("backgroundOther")</p>
                                </a>
                            </li>
