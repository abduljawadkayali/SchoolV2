...
@section('content')
    ...
    <form method="post" action="{{ route('disacount.update', $data->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="col-md-4">@lang("disacount")</label>
            <div class="col-md-8">
                <input type="text" name="disacount" value="{{ $data->disacount }}" class="form-control input-lg"  />
            </div>
        </div>
